...
<script lang="ts">
    ...
    import type {GetBillOfMaterialsResponse, Header} from "../../lib/OnshapeAPI/GetBillOfMaterialsResponse";
            ...
            {#each Object.values(colFilters) as {name, visible, propertyId}, idx}
                <div class="col-md-3">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="col-check-{idx}"
                               bind:checked={colFilters[propertyId].visible}>
